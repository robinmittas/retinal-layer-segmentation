...
def non_local_block(
    ...
    if len(ip_shape) == 3:  # temporal / time series cross_domain
        rank = 3
        batchsize, dim1, channels = ip_shape

    elif len(ip_shape) == 4:  # spatial / image cross_domain
        rank = 4
    ...
    elif len(ip_shape) == 5:  # spatio-temporal / Video or Voxel cross_domain
        rank = 5
